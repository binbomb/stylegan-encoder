...
def main():
    ...
    parser.add_argument('--model_url', default='https://s3-us-west-2.amazonaws.com/nanonets/blogs/karras2019stylegan-ffhq-1024x1024.pkl', help='Fetch a StyleGAN model to train on from this URL') # karras2019stylegan-ffhq-1024x1024.pkl
    ...
    if (args.use_lpips_loss > 0.00000001):
        with dnnlib.util.open_url('https://s3-us-west-2.amazonaws.com/nanonets/blogs/karras2019stylegan-ffhq-1024x1024.pkl', cache_dir=config.cache_dir) as f:
